    ...
    <form class="form-horizontal" action="search_keyword.php">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input id="keyword" type="search" name="keyword" placeholder="e.g. chicken"
    ...
    <form class="form-horizontal" action="add_joke.php">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input id="newjoke" type="text" name="newjoke" placeholder="joke question"
                        class="form-control input-md" required="">
                    <p class="help-block">Enter the joke question</p>
                </div>
                <label class="col-md-4 control-label" for="jokeanswer">Joke Answer</label>
                <div class="col-md-5">
                    <input id="jokeanswer" type="text" name="jokeanswer" placeholder="joke answer"
                        class="form-control input-md" required="">

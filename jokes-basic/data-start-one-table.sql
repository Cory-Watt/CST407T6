...
--
INSERT INTO
  `jokes_table` (`JokeID`, `Joke_question`, `Joke_answer`)
VALUES
  (
    1,
  ...
  (
    3,
    'What did the mother buffalo say to her son when she dropped him off at school?',
    'Bison'
  ),
  (
    4,
  ...
  (
    5,
    'What happens to a frog when his car breaks down?',
    'He gets toad.'
  ),
  (
    6,
    'How does a frog start his car when the battery is dead?',
    'He gets a jump start.'
  ),
  (
    7,
  ...
  (
    13,
    ' What did the duck say when he purchased new lipstick?',
    'Put that on my bill.'
  ),
